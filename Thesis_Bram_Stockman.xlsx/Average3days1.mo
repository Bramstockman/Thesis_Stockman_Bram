...
model Average3days1
  "Calculate the running mean temperature of 3 days, acccording to norm EN15251"
  ...
  parameter Real coeTRm[3] = {1, 0.6, 0.3}./1.9
    "weighTAmb.yg coefficient for the running average";
  discrete Real[3] TAveDay(each unit="K",each displayUnit = "degC")
