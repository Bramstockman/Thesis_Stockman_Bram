...
model RBC_model_ASHRAE_night_setback "RBC model with night set back"
  ...
  IDEAS.Controls.SetPoints.OccupancySchedule occSch(
    ...
    occupancy=3600*{6,17,30,41,54,65,78,89,102,113,126,137,150,161})
...
equation
  ...
  connect(upscaleCase900_HVAC.TSensor[1], Lowerbound_error.u1) annotation (Line(
        points={{-19.4,-176},{-10,-176},{-10,-234},{-352,-234},{-352,-268},{
          -298,-268}},
                  color={0,0,127}));
  ...
  connect(conPIDOutHeat.y, gain2.u) annotation (Line(points={{234.8,-206},{
          246,-206},{246,-221},{258.6,-221}}, color={0,0,127}));
  ...
  connect(and1.u2, occSch.occupied) annotation (Line(points={{-220,66},{-226,
          66},{-226,-14},{-281,-14}}, color={255,0,255}));
  annotation (Diagram(coordinateSystem(extent={{-360,-360},{340,160}})), Icon(
        coordinateSystem(extent={{-360,-360},{340,160}})));
end RBC_model_ASHRAE_night_setback;
