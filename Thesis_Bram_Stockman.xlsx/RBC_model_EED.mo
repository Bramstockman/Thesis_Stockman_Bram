...
model RBC_model_EED
  ...
  UpscaleCase900                      upscaleCase900_HVAC
    annotation (Placement(transformation(extent={{-52,-178},{-22,-158}})));
  ...
  IDEAS.Controls.Continuous.LimPID conPIDOutHeat(
    ...
    k=1,
    Ti=60)
    annotation (Placement(transformation(extent={{220,-222},{236,-206}})));
  ...
  Modelica.Blocks.Logical.Switch switch1
    annotation (Placement(transformation(extent={{302,-250},{322,-230}})));
  ...
  Modelica.Blocks.Sources.Constant const(k=0)
    annotation (Placement(transformation(extent={{-258,-40},{-244,-26}})));
  Modelica.Blocks.Logical.LogicalSwitch logicalSwitch
    annotation (Placement(transformation(extent={{264,-6},{280,10}})));
...
equation
  connect(upscaleCase900_HVAC.heatPortEmb, embeddedPipe.heatPortEmb)
    annotation (Line(points={{-22,-162},{74,-162},{74,-108}},
                                                           color={191,0,0}));
  ...
  connect(SwitchHeatCoolBorefield.switch, SwitchHeatCoolEmbeddedPipe.switch)
    annotation (Line(points={{-84.4,-4},{-116,-4},{-116,156},{172,156},{172,
          -4},{66.4,-4}},
                      color={255,0,255}));
  ...
  connect(not1.y, SwitchHeatCoolEmbeddedPipe.switch) annotation (Line(points={{-235.4,
          120},{-216,120},{-216,156},{172,156},{172,-4},{66.4,-4}},
                                                     color={255,0,255}));
  ...
  connect(Heating.y, switch1.u2) annotation (Line(points={{-275.4,120},{-268,
          120},{-268,-212},{116,-212},{116,-240},{300,-240}},
                                                            color={255,0,255}));
  connect(conPIDOutCool.u_m, conPIDOutHeat.u_m) annotation (Line(points={{230,
          -269.6},{230,-312},{82,-312},{82,-236},{228,-236},{228,-223.6}},
        color={0,0,127}));
  ...
  connect(switch2.u2, switch1.u2) annotation (Line(points={{-126,-96},{-264,
          -96},{-264,-212},{116,-212},{116,-240},{300,-240}},
                                                            color={255,0,255}));
  ...
  connect(or1.u2, SwitchHeatCoolEmbeddedPipe.switch) annotation (Line(points={{-195.4,
          43.4},{-216,43.4},{-216,156},{172,156},{172,-4},{66.4,-4}},
        color={255,0,255}));
  ...
  connect(const.y, switch3.u3) annotation (Line(points={{-243.3,-33},{-163.65,
          -33},{-163.65,-32.4},{-121.6,-32.4}}, color={0,0,127}));
  connect(logicalSwitch.y, booleanToReal.u) annotation (Line(points={{280.8,2},
          {290,2},{290,27},{296.6,27}}, color={255,0,255}));
  connect(logicalSwitch.u2, switch3.u2) annotation (Line(points={{262.4,2},{
          180,2},{180,172},{-222,172},{-222,-26},{-121.6,-26}},
                                                              color={255,0,
          255}));
  connect(logicalSwitch.u3, booleanConstant.y) annotation (Line(points={{262.4,
          -4.4},{260,-4.4},{260,-4},{254,-4},{254,-17},{250.7,-17}},
                                                         color={255,0,255}));
  ...
  connect(switch4.u2, switch3.u2) annotation (Line(points={{217.6,-66},{226,
          -66},{226,2},{180,2},{180,172},{-222,172},{-222,-26},{-121.6,-26}},
        color={255,0,255}));
  ...
  connect(add1.y, conPIDOutHeat.u_m) annotation (Line(points={{73,-276},{82,
          -276},{82,-236},{228,-236},{228,-223.6}}, color={0,0,127}));
  ...
  connect(HeatingCurveOut.y, conPIDOutHeat.u_s)
    annotation (Line(points={{197,-214},{218.4,-214}}, color={0,0,127}));
  connect(conPIDOutCool.u_s, CoolingCurveOut.y)
    annotation (Line(points={{220.4,-260},{201,-260}}, color={0,0,127}));

  connect(logicalSwitch.u1, not1.u) annotation (Line(points={{262.4,8.4},{186,
          8.4},{186,182},{-268,182},{-268,120},{-249.2,120}},
        color={255,0,255}));
  ...
  connect(conPIDHeatPump.y, switch5.u1) annotation (Line(points={{260.8,74},{
          278,74},{278,74.4},{286.4,74.4}}, color={0,0,127}));
  connect(switch5.u2, not1.u) annotation (Line(points={{286.4,68},{276,68},{
          276,50},{186,50},{186,182},{-268,182},{-268,120},{-249.2,120}},
                        color={255,0,255}));
  ...
  connect(switch5.y, heaPum.y) annotation (Line(points={{304.8,68},{314,68},{
          314,164},{-44,164},{-44,22},{-17,22},{-17,30}}, color={0,0,127}));
  connect(upscaleCase900_HVAC.TSensor[1], Lowerbound_error.u1) annotation (Line(
        points={{-21.4,-174},{-10,-174},{-10,-238},{-352,-238},{-352,-268},{
          -298,-268}},
                  color={0,0,127}));
  ...
  connect(switch5.y, switch8.u1) annotation (Line(points={{304.8,68},{314,68},
          {314,164},{139,164},{139,79}},
                                    color={0,0,127}));
  ...
  connect(conPIDOutHeat.y, gain2.u) annotation (Line(points={{236.8,-214},{
          246,-214},{246,-221},{258.6,-221}}, color={0,0,127}));
  connect(switch1.u1, gain2.y) annotation (Line(points={{300,-232},{290,-232},
  ...
  connect(switch1.u3, gain3.y) annotation (Line(points={{300,-248},{290,-248},
          {290,-253},{276.7,-253}}, color={0,0,127}));
  connect(switch1.y, switch4.u1) annotation (Line(points={{323,-240},{332,
